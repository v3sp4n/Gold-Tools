...
function EXPORTS.Crash()
		...
		print('[ Download ] Crash Tools [imgui].lua Успешно загружен!')
...
function EXPORTS.mp3(id)
	if id == 0 then -- give damage (Дать урон)
		...
		print('[ Download ] give damage.mp3 Успешно загружен!')
	...
	print('[ Download ] take damage.mp3 Успешно загружен!')
	...
	elseif id == 2 then -- notification (Уведомления)
		...
		print('[ Download ] notification.mp3 Успешно загружен!')
	elseif id == 3 then -- report++
		...
		print('[ Download ] report++.mp3 Успешно загружен!')
	end
end
