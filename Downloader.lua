...
function EXPORTS.mp3(id)
	...
	downloadUrlToFile('https://cdn.discordapp.com/attachments/725657585377607683/850310984270872617/Minecraft-death-sound.mp3', 'moonloader\\Gold Tools\\mp3\\take damage.mp3', function(id, status, p1, p2)
	end)
